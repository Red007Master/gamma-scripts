...
```wget https://raw.githubusercontent.com/ViridiLV/G.A.M.M.A-Community-Linux-Install-Setup-shell-scripts/refs/heads/main/gamma-scripts.sh && chmod -x gamma-scripts.sh```
